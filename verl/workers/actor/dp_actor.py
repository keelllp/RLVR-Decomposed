...
try:
    ...
    def pad_input(x, *args, **kwargs): return x
    def unpad_input(x, *args, **kwargs): return x
    def rearrange(x, *args, **kwargs): return x
    def index_first_axis(x, *args, **kwargs): return x
